    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AidTypes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllocatedDisasterId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoodsDonations_Disasters_AllocatedDisasterId",
                        column: x => x.AllocatedDisasterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonetaryDonations_Disasters_AllocatedDisasterId",
                        column: x => x.AllocatedDisasterId,
                        principalTable: "Disasters",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Food aid", "Food" },
                    { 2, "Medical aid", "Medical" },
                    { 3, "Shelter aid", "Shelter" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsDonations_AllocatedDisasterId",
                table: "GoodsDonations",
                column: "AllocatedDisasterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonetaryDonations_AllocatedDisasterId",
